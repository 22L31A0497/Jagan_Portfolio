...
export const Bio = {
    ...
    resume: "https://drive.google.com/file/d/1TH8AO0nQ01_Mif9PHqpVWD_Lt2qwzr9V/view?usp=drivesdk",
...
export const experiences = [
  {
    ...
    desc: "Developed a Blog Website where users can create manually written or AI-generated posts with images, using prompt-based generation. Enabled users to explore, react to, and comment on blogs with a Reddit-style nested comment system. Built full-stack Mentor and Mentee Dashboards with login/signup, availability, booking system, and profile management. Implemented secure JWT authentication, modular Node.js + Express APIs, and MongoDB integration. Led a team of 20 members, managing progress via Git-based collaboration.",
    skills: [
      "ReactJS",
      "NodeJs",
      "ExpressJs",
  ...
  },
  {
    ...
    desc: "Built a To-Do web app using React.js and Local Storage, ensuring data persistence and a user-friendly experience. Designed and developed responsive UI components using clean HTML/CSS, improving cross-device accessibility.",
    skills: [
      "ReactJS",
      "HTML",
      "CSS",
  ...
  export const education = [
    ...
    },
    {
      id: 1,
      img: SriChaitanya,
      school: "AIIMS Junior College, Srikakulam",
  ...
  - Implemented role-based routing for doctors and patients with modern, responsive UI.
  - Includes secure form validation, OTP login, and toggle-based registration with live session booking.
...
export const codingProfiles = [
  
  {
    ...
    link: "https://leetcode.com/u/kuna_jaganmohan_rao_2004/",
  },
  {
    name: "Codechef",
